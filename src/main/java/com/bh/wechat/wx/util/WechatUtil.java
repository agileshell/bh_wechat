...
import com.bh.wechat.wx.model.AccessToken;
...
public class WechatUtil {
    ...
    public static String getToken() {
        AccessToken at = WechatUtil.getAccessToken(GlobalProperties.WECAHT_APP_ID, GlobalProperties.WECAHT_APP_SECRET);
        if (null != at) {
            return at.getToken();
        } else {
            return null;

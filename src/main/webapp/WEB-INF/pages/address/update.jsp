...
<!-- header start -->
<c:set var="header_name" value="修改地址" />
    ...
    <div class="new-info-box">
        <div class="new-set-info">
            ...
            <span class="new-input-span new-mg-b10">
                <input type="text" name="name" id="name" maxlength="25" class="new-input" value="${address.name}" autocomplete="off">
            </span>
            ...
            <span class="new-span-block new-mg-b10">
                <span class="new-input-span">
                    <input type="text" name="mobile" id="mobile" class="new-input" value="${address.mobile}" autocomplete="off">
                </span>
                    ...
                    <span class="new-tbl-cell">
                        <span class="new-input-span new-mg-b10">
                            <span class="new-sel-box new-p-re">
                                <div id="province_text">${address.firstLocation.name}</div>
                                <span></span> 
                                <select id="address_province" class="new-select">
                                    <option value="0">请选择</option>
                                    <c:forEach items="${firstLocations}" var="location">
                                        <option ${location.locationId == address.firstLocation.locationId ? 'selected' : ''} value="${location.locationId}" id="option${location.locationId}">${location.name}</option>
                                    </c:forEach>
                                </select>
                            </span>
                        </span>
            ...
            <div class="new-mg-t10">
                <span class="new-tbl-type new-mg-b10">
                    ...
                    <span class="new-tbl-cell">
                        <span class="new-input-span new-mg-b10">
                            <span class="new-sel-box new-p-re">
                                <div id="city_text">${address.secondLocation.name}</div>
                                <span></span> 
                                <select id="address_city" class="new-select">
                                    <option value="0">请选择</option>
                                    <option selected value="${address.secondLocation.locationId}" id="option${address.secondLocation.locationId}">${address.secondLocation.name}</option>
                                </select>
                            </span>
                        </span>
                    </span>
            ...
            <div class="new-mg-t10">
                <span class="new-tbl-type new-mg-b10">
                    ...
                    <span class="new-tbl-cell">
                        <span class="new-input-span new-mg-b10">
                            <span class="new-sel-box new-p-re">
                                <div id="location_text">${address.location.name}</div>
                                <span></span> 
                                <select id="address_location" class="new-select">
                                    <option value="0">请选择</option>
                                    <option selected value="${address.location.locationId}" id="option${address.location.locationId}">${address.location.name}</option>
                                </select>
                            </span>
                        </span>
                    </span>
                ...
                <span class="new-tbl-type new-mg-b10">
                    ...
                    <span class="new-tbl-cell">
                        <div class="new-post_wr">
                            <textarea name="address" id="address" rows="5" cols="30" class="new-textarea">${address.address}</textarea>
                        </div>
        ...
        <a href="javascript:void(0);" id="address_submit" class="new-abtn-type new-mg-t15">修改地址</a>
    </div>
</div>
